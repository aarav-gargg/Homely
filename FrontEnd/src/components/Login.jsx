...
const Login = () => {
    return (
        <div className='bg-fav-color h-screen w-screen flex '>
            <div className='text-white text-center w-full flex flex-col items-center my-11'>
                ...
                <form className='border-4 border-slate-100 rounded-lg p-8 max-w-lg w-full shadow-2xl bg-f-color '>
                    ...
                    <div className='my-5 text-white'>
                        Not a member yet? <Link to="/Register" className='text-blue-500 hover:underline'>SignUp here</Link>
                    </div>
                </form>
            </div>
        </div>
